'''
   Algorithm Name :- Image Classifcation using Fully convolution neural network (FCN) in keras
   Author name :- Prateek Mishra (0xprateek)
   Kaggle Kernel :- https://www.kaggle.com/prateek0x/fcn-for-image-classification-using-keras
   
In this Kernel I am implementing Fully Convolution neural network for image classfication.
